...
São disponibilizados algoritmos de demonstração do livro em 30 linguagens de programação. Veja a seguir os nomes das linguagens, anos de lançamento, extensões de gravação dos programas-fonte, autores ou líderes de projetos:
