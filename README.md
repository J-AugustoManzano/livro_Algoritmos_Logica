...
Neste momento estão disponibilizados algoritmos de demonstração do livro texto indicado acima nas seguintes linguagens de programação, indicando nome da linguagem, ano de lançamento, extensão de gravação dos programas-fonte, autores ou líderes de projetos:
